...
class ColorRLProgram(Controller):
    """
    ...
    def __init__(self, hparams, item, cluster, controller_id=0):
        ...
        """
        super(ColorRLProgram, self).__init__(item, cluster)
    ...
    def build_program(self):
        ...
        with tf_ops.name_scope("controller_{}".format(self.ctrl_id)):
            ...
            ctr["debug_ppo"] = {"log_probs": ctr["log_probs"], "grouping_log_probs": ctr["grouping_log_probs"]}
    ...
    def _get_train_ops(self,
        ...
        return train_op, learning_rate, grad_norm, all_grad_norms, {"grads_and_vars": grads_and_vars}
